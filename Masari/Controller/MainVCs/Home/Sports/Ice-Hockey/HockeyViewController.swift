...
class HockeyViewController: UIViewController {
    ...
    func setupViewPager(){
        ...
        let vc1 = mainStoryboard.instantiateViewController(withIdentifier: "HockeyTodayMatchVC") as! HockeyTodayMatchVC
        vc1.title = "Today"
        let vc2 = mainStoryboard.instantiateViewController(withIdentifier: "HockeyTomorrowMatchVC") as! HockeyTomorrowMatchVC
        vc2.title = "Tommorow"
...
extension HockeyViewController: LZViewPagerDelegate, LZViewPagerDataSource{
