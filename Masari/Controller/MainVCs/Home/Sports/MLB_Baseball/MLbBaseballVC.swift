...
class MLbBaseballVC: UIViewController {
    ...
    func setupViewPager(){
        ...
        let vc1 = mainStoryboard.instantiateViewController(withIdentifier: "BaseballTodayMatchVC") as! BaseballTodayMatchVC
        vc1.title = "Today"
        let vc2 = mainStoryboard.instantiateViewController(withIdentifier: "BaseballTommorowMatchVC") as! BaseballTommorowMatchVC
        vc2.title = "Tommorow"
...
extension MLbBaseballVC: UITableViewDelegate, UITableViewDataSource {
...
extension MLbBaseballVC: LZViewPagerDelegate, LZViewPagerDataSource{
